...
use crate::net::{SockaddrConvert, SocketAddrV4IntoSockAddrV4Buffer, SocketAddrV6IntoSockAddrV6Buffer, TimeValFromDuration, ToIpv4Addr, ToIpv6Addr};
...
impl ToIpv4Addr for SockAddrIn {
    ...
    fn to_ipv4_addr(&self) -> std::net::Ipv4Addr {
        std::net::Ipv4Addr::from(u32::from_be(self.sin_addr.s_addr))
    }
